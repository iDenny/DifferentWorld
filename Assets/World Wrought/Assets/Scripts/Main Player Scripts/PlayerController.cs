...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        animator.SetFloat("Velocity Y", moveVertical * currentSpeedMultiplier);
        ...
        animator.SetBool("isFalling", !isGrounded && !isJumping && verticalVelocity.y < -0.4f); // Adjust the threshold here
